    ...
    <div class="container-fluid">
        <div class="row ">
            ...
            <div class="col-xl-10 content"> 
                ...
                <form method="post">
                    <p><span>Họ tên:</span><input type="text" name="tHoten" value="<?php echo $fetched_row['hoten']; ?>" required /></p>
                    <p><span>Username:</span><input minlength="6" maxlength="50" type="text" name="tUsername" value="<?php echo $fetched_row['username']; ?>"></p>
                    <p><span>Password:</span><input minlength="6" maxlength="50" type="text" name="tPassword" value="<?php echo $fetched_row['password']; ?>"></p>
